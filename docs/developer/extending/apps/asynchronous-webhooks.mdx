...
To validate signatures in Saleor Apps use [`withWebhookSignatureVerified`](https://github.com/saleor/saleor-app-sdk/blob/main/src/middleware.ts#L62) middleware provbided by [`saleor-app-sdk`](https://github.com/saleor/saleor-app-sdk)
